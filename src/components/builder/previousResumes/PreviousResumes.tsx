        ...
        return (
          ...
          >
            <div
              ...
              className='h-60 md:h-80 w-full md:w-72 p-3 gap-1 flex flex-col justify-between items-center cursor-pointer'
            >
              ...
              <p className='text text-sm text-light-text-secondary self-start dark:text-dark-text-secondary'>
                Last Accessed -{' '}
                {format(resume.last_accessed, 'HH:mm a eee, dd MMM yyyy')}
              </p>
            </div>
